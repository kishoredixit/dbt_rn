{{ config(materialized='table') }} with recp_opportunitycontactrole as
    (select {{ md5_surrogatekey('Id') }} AS "dim_opportunitycontactrole_key",
...
select *
from recp_opportunitycontactrole