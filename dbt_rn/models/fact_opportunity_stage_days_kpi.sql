...
{{ date_diff_days ('hist_created_date','hist_closed_date') }}   sales_gestation 
...
case when map.'StageNumber' in(0,100) then max("createddate")  else current_timestamp end as hist_closed_date 
